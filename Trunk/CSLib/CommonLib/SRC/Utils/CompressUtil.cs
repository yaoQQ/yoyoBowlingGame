...
public static class CompressUtil 
{
    ...
    public static bool UnzipFile(Stream _inputStream, string _outputPath, string _password = null, UnzipCallback _unzipCallback = null)
    {
        ...
        using (ZipInputStream zipInputStream = new ZipInputStream(_inputStream))
        {
            ...
            while (null != (entry = zipInputStream.GetNextEntry()))
            {
                ...
                try
                {
                    string dirPath = Path.GetDirectoryName(filePathName);
    ...
    public static void AsynUnZip(string zipFullName, string targetPath, AsyncCallback onUnzipEnd)
    {
        ...
        try
        {
            ...
            while ((theEntry = zs.GetNextEntry()) != null)
            {
                ...
                else
                {
                    ...
                    ws.BeginWrite(bytes.ToArray(), 0, bytes.Count, onUnzipEnd, ws);
                }
            }
        }
        catch
