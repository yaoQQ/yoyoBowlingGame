...
namespace XLua.CSObjectWrap
{
    ...
    public class EmptyImageWidgetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(EmptyImageWidget);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					EmptyImageWidget __cl_gen_ret = new EmptyImageWidget();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EmptyImageWidget constructor!");
        ...
        static int _m_AddEventListener(RealStatePtr L)
        {
		    try {
                ...
                EmptyImageWidget __cl_gen_to_be_invoked = (EmptyImageWidget)translator.FastGetCSObj(L, 1);
