...
namespace XLua.CSObjectWrap
{
    ...
    public class UICustomEventWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(UICustomEvent), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(UICustomEvent), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(UICustomEvent), L, null, 7, 0, 0);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Change", UICustomEvent.Change);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "HrefClick", UICustomEvent.HrefClick);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "CellClick", UICustomEvent.CellClick);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Confirm", UICustomEvent.Confirm);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Complete", UICustomEvent.Complete);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Enter", UICustomEvent.Enter);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(UICustomEvent), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushUICustomEvent(L, (UICustomEvent)LuaAPI.xlua_tointeger(L, 1));
            }
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    if (LuaAPI.xlua_is_eq_str(L, 1, "Change"))
                {
                    translator.PushUICustomEvent(L, UICustomEvent.Change);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "HrefClick"))
                {
                    translator.PushUICustomEvent(L, UICustomEvent.HrefClick);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "CellClick"))
                {
                    translator.PushUICustomEvent(L, UICustomEvent.CellClick);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Confirm"))
                {
                    translator.PushUICustomEvent(L, UICustomEvent.Confirm);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Complete"))
                {
                    translator.PushUICustomEvent(L, UICustomEvent.Complete);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Enter"))
                {
                    translator.PushUICustomEvent(L, UICustomEvent.Enter);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for UICustomEvent!");
                }
            }
            else
            {
                return LuaAPI.luaL_error(L, "invalid lua type for UICustomEvent! Expect number or string, got + " + lua_type);
            }
    ...
    public class UIEventWrap
    {
        ...
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(UIEvent), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(UIEvent), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(UIEvent), L, null, 15, 0, 0);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "TriggleEnter", UIEvent.TriggleEnter);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PointerClick", UIEvent.PointerClick);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PointerDown", UIEvent.PointerDown);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PointerEnter", UIEvent.PointerEnter);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PointerUp", UIEvent.PointerUp);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PointerExit", UIEvent.PointerExit);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "DragBegin", UIEvent.DragBegin);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "DragEnd", UIEvent.DragEnd);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Drag", UIEvent.Drag);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PointerDoubleClick", UIEvent.PointerDoubleClick);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PointerShortClick", UIEvent.PointerShortClick);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PointerLongClick", UIEvent.PointerLongClick);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PinchIn", UIEvent.PinchIn);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PinchOut", UIEvent.PinchOut);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(UIEvent), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushUIEvent(L, (UIEvent)LuaAPI.xlua_tointeger(L, 1));
            }
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    if (LuaAPI.xlua_is_eq_str(L, 1, "TriggleEnter"))
                {
                    translator.PushUIEvent(L, UIEvent.TriggleEnter);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PointerClick"))
                {
                    translator.PushUIEvent(L, UIEvent.PointerClick);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PointerDown"))
                {
                    translator.PushUIEvent(L, UIEvent.PointerDown);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PointerEnter"))
                {
                    translator.PushUIEvent(L, UIEvent.PointerEnter);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PointerUp"))
                {
                    translator.PushUIEvent(L, UIEvent.PointerUp);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PointerExit"))
                {
                    translator.PushUIEvent(L, UIEvent.PointerExit);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "DragBegin"))
                {
                    translator.PushUIEvent(L, UIEvent.DragBegin);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "DragEnd"))
                {
                    translator.PushUIEvent(L, UIEvent.DragEnd);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Drag"))
                {
                    translator.PushUIEvent(L, UIEvent.Drag);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PointerDoubleClick"))
                {
                    translator.PushUIEvent(L, UIEvent.PointerDoubleClick);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PointerShortClick"))
                {
                    translator.PushUIEvent(L, UIEvent.PointerShortClick);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PointerLongClick"))
                {
                    translator.PushUIEvent(L, UIEvent.PointerLongClick);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PinchIn"))
                {
                    translator.PushUIEvent(L, UIEvent.PinchIn);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PinchOut"))
                {
                    translator.PushUIEvent(L, UIEvent.PinchOut);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for UIEvent!");
                }
            }
            else
            {
                return LuaAPI.luaL_error(L, "invalid lua type for UIEvent! Expect number or string, got + " + lua_type);
            }
    ...
    public class UISpineEventWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(UISpineEvent), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(UISpineEvent), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(UISpineEvent), L, null, 7, 0, 0);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Start", UISpineEvent.Start);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Interrupt", UISpineEvent.Interrupt);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "End", UISpineEvent.End);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Dispose", UISpineEvent.Dispose);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Complete", UISpineEvent.Complete);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Event", UISpineEvent.Event);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(UISpineEvent), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushUISpineEvent(L, (UISpineEvent)LuaAPI.xlua_tointeger(L, 1));
            }
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    if (LuaAPI.xlua_is_eq_str(L, 1, "Start"))
                {
                    translator.PushUISpineEvent(L, UISpineEvent.Start);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Interrupt"))
                {
                    translator.PushUISpineEvent(L, UISpineEvent.Interrupt);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "End"))
                {
                    translator.PushUISpineEvent(L, UISpineEvent.End);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Dispose"))
                {
                    translator.PushUISpineEvent(L, UISpineEvent.Dispose);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Complete"))
                {
                    translator.PushUISpineEvent(L, UISpineEvent.Complete);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Event"))
                {
                    translator.PushUISpineEvent(L, UISpineEvent.Event);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for UISpineEvent!");
                }
            }
            else
            {
                return LuaAPI.luaL_error(L, "invalid lua type for UISpineEvent! Expect number or string, got + " + lua_type);
            }
