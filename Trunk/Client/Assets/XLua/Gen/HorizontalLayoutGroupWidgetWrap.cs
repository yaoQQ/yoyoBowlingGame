...
namespace XLua.CSObjectWrap
{
    ...
    public class HorizontalLayoutGroupWidgetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(HorizontalLayoutGroupWidget);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "InnerHorizontalGroup", _g_get_InnerHorizontalGroup);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "InnerHorizontalGroup", _s_set_InnerHorizontalGroup);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					HorizontalLayoutGroupWidget __cl_gen_ret = new HorizontalLayoutGroupWidget();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to HorizontalLayoutGroupWidget constructor!");
        ...
        static int _m_GetWidgetType(RealStatePtr L)
        {
		    try {
                ...
                HorizontalLayoutGroupWidget __cl_gen_to_be_invoked = (HorizontalLayoutGroupWidget)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_InnerHorizontalGroup(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                HorizontalLayoutGroupWidget __cl_gen_to_be_invoked = (HorizontalLayoutGroupWidget)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.InnerHorizontalGroup);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_InnerHorizontalGroup(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                HorizontalLayoutGroupWidget __cl_gen_to_be_invoked = (HorizontalLayoutGroupWidget)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.InnerHorizontalGroup = (UnityEngine.UI.HorizontalLayoutGroup)translator.GetObject(L, 2, typeof(UnityEngine.UI.HorizontalLayoutGroup));
