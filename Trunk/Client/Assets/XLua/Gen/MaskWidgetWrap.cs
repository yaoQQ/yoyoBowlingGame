...
namespace XLua.CSObjectWrap
{
    ...
    public class MaskWidgetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MaskWidget);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "uiMask", _g_get_uiMask);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "maskImg", _s_set_maskImg);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "uiMask", _s_set_uiMask);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MaskWidget __cl_gen_ret = new MaskWidget();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MaskWidget constructor!");
        ...
        static int _m_AddEventListener(RealStatePtr L)
        {
		    try {
                ...
                MaskWidget __cl_gen_to_be_invoked = (MaskWidget)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_uiMask(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                MaskWidget __cl_gen_to_be_invoked = (MaskWidget)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.uiMask);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_uiMask(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                MaskWidget __cl_gen_to_be_invoked = (MaskWidget)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.uiMask = (UnityEngine.UI.RectMask2D)translator.GetObject(L, 2, typeof(UnityEngine.UI.RectMask2D));
