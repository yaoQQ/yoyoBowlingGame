    ...
    public class UnityEngineTrailRendererWrap 
    {
        ...
        static int _m_DOResize(RealStatePtr L)
        {
		    try {
                ...
                {
                    float toStartWidth = (float)LuaAPI.lua_tonumber(L, 2);
                    float toEndWidth = (float)LuaAPI.lua_tonumber(L, 3);
                    float duration = (float)LuaAPI.lua_tonumber(L, 4);
                    
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOResize( toStartWidth, toEndWidth, duration );
                        translator.Push(L, __cl_gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener __cl_gen_ret = __cl_gen_to_be_invoked.DOTime( endValue, duration );
                        translator.Push(L, __cl_gen_ret);
