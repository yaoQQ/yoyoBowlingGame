...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<UICustomEvent>(translator.PushUICustomEvent, translator.Get, translator.UpdateUICustomEvent);
				translator.RegisterPushAndGetAndUpdate<UIEvent>(translator.PushUIEvent, translator.Get, translator.UpdateUIEvent);
				translator.RegisterPushAndGetAndUpdate<UISpineEvent>(translator.PushUISpineEvent, translator.Get, translator.UpdateUISpineEvent);
        ...
        int UICustomEvent_TypeID = -1;
		int UICustomEvent_EnumRef = -1;
        
        public void PushUICustomEvent(RealStatePtr L, UICustomEvent val)
        {
            if (UICustomEvent_TypeID == -1)
            {
			    bool is_first;
                UICustomEvent_TypeID = getTypeId(L, typeof(UICustomEvent), out is_first);
				
				if (UICustomEvent_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(UICustomEvent));
				    UICustomEvent_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, UICustomEvent_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, UICustomEvent_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for UICustomEvent ,value="+val);
            }
			
			LuaAPI.lua_getref(L, UICustomEvent_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out UICustomEvent val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != UICustomEvent_TypeID)
				{
				    throw new Exception("invalid userdata for UICustomEvent");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for UICustomEvent");
                }
				val = (UICustomEvent)e;
            ...
            {
                val = (UICustomEvent)objectCasters.GetCaster(typeof(UICustomEvent))(L, index, null);
            }
        }
		
        public void UpdateUICustomEvent(RealStatePtr L, int index, UICustomEvent val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for UICustomEvent ,value="+val);
                }
            }
        ...
        int UIEvent_TypeID = -1;
		int UIEvent_EnumRef = -1;
        
        public void PushUIEvent(RealStatePtr L, UIEvent val)
        {
            if (UIEvent_TypeID == -1)
            {
			    bool is_first;
                UIEvent_TypeID = getTypeId(L, typeof(UIEvent), out is_first);
				
				if (UIEvent_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(UIEvent));
				    UIEvent_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, UIEvent_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, UIEvent_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for UIEvent ,value="+val);
            }
			
			LuaAPI.lua_getref(L, UIEvent_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out UIEvent val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != UIEvent_TypeID)
				{
				    throw new Exception("invalid userdata for UIEvent");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for UIEvent");
                }
				val = (UIEvent)e;
            ...
            {
                val = (UIEvent)objectCasters.GetCaster(typeof(UIEvent))(L, index, null);
            }
        }
		
        public void UpdateUIEvent(RealStatePtr L, int index, UIEvent val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for UIEvent ,value="+val);
                }
            }
        ...
        int UISpineEvent_TypeID = -1;
		int UISpineEvent_EnumRef = -1;
        
        public void PushUISpineEvent(RealStatePtr L, UISpineEvent val)
        {
            if (UISpineEvent_TypeID == -1)
            {
			    bool is_first;
                UISpineEvent_TypeID = getTypeId(L, typeof(UISpineEvent), out is_first);
				
				if (UISpineEvent_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(UISpineEvent));
				    UISpineEvent_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, UISpineEvent_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, UISpineEvent_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for UISpineEvent ,value="+val);
            }
			
			LuaAPI.lua_getref(L, UISpineEvent_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out UISpineEvent val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != UISpineEvent_TypeID)
				{
				    throw new Exception("invalid userdata for UISpineEvent");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for UISpineEvent");
                }
				val = (UISpineEvent)e;
            ...
            {
                val = (UISpineEvent)objectCasters.GetCaster(typeof(UISpineEvent))(L, index, null);
            }
        }
		
        public void UpdateUISpineEvent(RealStatePtr L, int index, UISpineEvent val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for UISpineEvent ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(UICustomEvent[]))
			{
			    UICustomEvent[] array = obj as UICustomEvent[];
				translator.PushUICustomEvent(L, array[index]);
				return true;
			}
			else if (type == typeof(UIEvent[]))
			{
			    UIEvent[] array = obj as UIEvent[];
				translator.PushUIEvent(L, array[index]);
				return true;
			}
			else if (type == typeof(UISpineEvent[]))
			{
			    UISpineEvent[] array = obj as UISpineEvent[];
				translator.PushUISpineEvent(L, array[index]);
				return true;
			}
            return false;
		}
