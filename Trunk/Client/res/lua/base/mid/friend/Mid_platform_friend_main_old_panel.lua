...
Mid_platform_friend_main_old_panel={}
local this = Mid_platform_friend_main_old_panel
...
function this:init(gameObject)
	self.go=gameObject
	self.back_Image=self.go.transform:Find("top_Panel /back_Image"):GetComponent(typeof(ImageWidget))
	self.portraits_image=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image"):GetComponent(typeof(CircleImageWidget))
	self.repu_Text=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image/repu_Text"):GetComponent(typeof(TextWidget))
	self.distance_Text=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image/distance_Text"):GetComponent(typeof(TextWidget))
	self.name_Text=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image/name_Text"):GetComponent(typeof(TextWidget))
	self.id_Text=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image/id_Text"):GetComponent(typeof(TextWidget))
	self.address_Text=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image/address_Text"):GetComponent(typeof(TextWidget))
	self.sex_Image=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image/sex_Image"):GetComponent(typeof(ImageWidget))
	self.sexbg_Icon=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image/sex_Image/sexbg_Icon"):GetComponent(typeof(IconWidget))
	self.level_Text=self.go.transform:Find("top_Panel /baseinfo_Panel/portraits_image/sex_Image/level_Text"):GetComponent(typeof(TextWidget))
