...
Mid_platform_active_chatroom_panel={}
local this = Mid_platform_active_chatroom_panel
...
function this:init(gameObject)
	...
	self.mask_Image=self.go.transform:Find("chat/mask_Image"):GetComponent(typeof(EmptyImageWidget))
	...
	self.chat_back_Image=self.go.transform:Find("chat_back_Image"):GetComponent(typeof(ImageWidget))
	self.chatCellArr={}
