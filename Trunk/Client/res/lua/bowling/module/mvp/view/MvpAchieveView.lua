...
--主界面
MvpAchieveView = BaseView:new()
local this = MvpAchieveView
this.viewName = "MvpAchieveView"

--设置面板特性
this:setViewAttribute(UIViewType.Platform_Help_View, UIViewEnum.MvpGame_Achieve_View, false)

--设置加载列表
this.loadOrders = {
    "mvpgame:achieve_view"
}
...
function this.close()
    ViewManager.close(UIViewEnum.MvpGame_Achieve_View)
end
