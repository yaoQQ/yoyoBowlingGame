...
public class ModelExportManager
{
    ...
    {
        return "/../../../" + PathUtil.GetClientName() + "/res/model/";
    }
    static string Get_IOS_expPath()
    {
        return "/../../../" + PathUtil.GetClientName() + "/ios_res/model/";
    }

    static string Get_Android_expPath()
    {
        return "/../../../" + PathUtil.GetClientName() + "/android_res/model/";
    }
    ...
    [MenuItem("Export/Model/Exp Model Res (PC)")]
    public static void ExpModelRes_PC()
    {
        ExpModelRes(BuildTarget.StandaloneWindows64);
    }
    [MenuItem("Export/Model/Exp Model Res (Android)")]
    public static void ExpModelRes_Android()
    {
        ExpModelRes(BuildTarget.Android);
    }
    [MenuItem("Export/Model/Exp Model Res (IOS)")]
    public static void ExpModelRes_IOS()
    {
        ExpModelRes(BuildTarget.iOS);
    }

    static void ExpModelRes(BuildTarget target)
    {
        string[] packageDirArr = Directory.GetDirectories(Application.dataPath + "/Project/" + ProjectUtil.GetCurProjectName() + "/model");
        ...
        EditorUtility.DisplayDialog("导出", "项目 " + ProjectUtil.GetCurProjectName() + " 导出模型资源成功", "确定");
    }
